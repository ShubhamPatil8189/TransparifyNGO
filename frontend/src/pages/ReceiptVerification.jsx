...
const ReceiptVerification = () => {
  const verificationHash = "0x1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b";
      ...
      <header className="bg-card border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">NGO Transparency Portal</span>
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-lg text-center">
          ...
          <div className="bg-card rounded-lg p-8 text-left">
            ...
            <p className="text-sm text-muted-foreground mb-6">Transaction details as recorded in our system.</p>

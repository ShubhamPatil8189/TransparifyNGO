...
import { DollarSign, Users, FileText, Heart, ChevronRight, Shield, BarChart3, Receipt } from "lucide-react";
      ...
      <header className="bg-card border-b sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            ...
            <div>
              <span className="font-bold text-primary">Transparent</span>
              <span className="block text-xs text-muted-foreground">NGO Network</span>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link to="/donor-login" className="px-4 py-2 border border-primary text-primary rounded-lg hover:bg-primary hover:text-primary-foreground transition-colors">
              Login / Sign Up
            </Link>
          </nav>
        </div>
